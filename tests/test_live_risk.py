...
def test_live_risk_blocks_kill_switch() -> None:
    ...
    result = RiskManager(config).evaluate(
        detection, build_wallet(), fill, "LIVE", 0, 0, 0, 0, True, True, True,
        category="politics", market_id="m1", live_ready=True, kill_switch=True
    )
